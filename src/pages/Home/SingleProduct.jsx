...
const SingleProduct = () => {
  ...
  return (
    <div className="mt-28 max-w-screen-2xl container mx-auto xl:px-28 px-4 font-light ">
      ...
      {/* product details */}
      <div className="mt-10">
        <h2 className="text-sm font-light text-gray-900">Details</h2>
      ...
      <div className="mt-10">
        <h2 className="text-sm font-light text-gray-900">Description</h2>
      ...
      <div className="mt-5">
        <h2 className="text-sm font-light text-gray-900">Highlights</h2>
