...
const Banner = () => {
  return (
    <div className="bg-primaryBG py-12 xl:px-28 px-4 font-light">
      ...
      <div className="md:w-1/2">
        ...
        <div className="md:w-1/2 w-full">
          ...
          <button className="bg-Black hover:bg-orange-500 px-6 py-2 text-white font-light flex gap-2 items-center rounded-sm">
