...
const Products = () => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-28 px-4 mb-12">
      <h2 className="text-3xl font-light capitalize text-center my-8">
      ...
      <div>
        ...
        <div className="flex flex-row justify-start md:items-center md:gap-8 gap-4 font-light flex-wrap">
          <button
            onClick={showAll}
